 ...
 */
// Generated on: 20.08.2025 21:16:58
...
const TfArray<1, float> quant0_scale = { 1, { 0.0328085757791996, } };
const TfArray<1, int> quant0_zero = { 1, { 8 } };
const TfLiteAffineQuantization quant0 = { (TfLiteFloatArray*)&quant0_scale, (TfLiteIntArray*)&quant0_zero, 0 };
const MODEL_SECTION(EI_MODEL_SECTION) ALIGN(8) int32_t tensor_data1[2] = { 187, -187, };
const TfArray<1, int> tensor_dimension1 = { 1, { 2 } };
const TfArray<1, float> quant1_scale = { 1, { 0.00072895060293376446, } };
const TfArray<1, int> quant1_zero = { 1, { 0 } };
const TfLiteAffineQuantization quant1 = { (TfLiteFloatArray*)&quant1_scale, (TfLiteIntArray*)&quant1_zero, 0 };
const MODEL_SECTION(EI_MODEL_SECTION) ALIGN(16) int8_t tensor_data2[2*8] = { 
  -22, -111, 114, 127, 82, -110, -25, -116, 
  99, 64, -87, -82, -67, 66, -62, 88, 
};
const TfArray<2, int> tensor_dimension2 = { 2, { 2,8 } };
const TfArray<1, float> quant2_scale = { 1, { 0.011299696750938892, } };
const TfLiteAffineQuantization quant2 = { (TfLiteFloatArray*)&quant2_scale, (TfLiteIntArray*)&g0::quant1_zero, 0 };
const MODEL_SECTION(EI_MODEL_SECTION) ALIGN(16) int32_t tensor_data3[8] = { 96, 545, 1414, 1346, 114, 639, -582, 160, };
const TfArray<1, int> tensor_dimension3 = { 1, { 8 } };
const TfArray<1, float> quant3_scale = { 1, { 0.00020685161871369928, } };
...
const MODEL_SECTION(EI_MODEL_SECTION) ALIGN(16) int8_t tensor_data4[8*16] = { 
  13, 86, 56, -49, 112, 127, -19, 55, -95, -32, -47, 20, 67, 84, -15, 3, 
  -20, 64, 68, -26, 53, 84, -3, 54, -54, -42, -70, 56, 34, 65, -4, 13, 
  6, -55, 5, 18, -59, -72, 59, 3, 78, 65, 31, -23, -37, 7, 60, 26, 
  45, -68, -43, 60, -16, -77, 27, 37, 97, 77, 24, 1, -76, -38, 58, -8, 
  -22, -65, -39, 36, -56, -67, 28, 49, 24, 8, 7, -30, -14, 31, 38, 12, 
  -33, 58, 61, 4, 84, 64, -7, -5, -63, -56, -79, 59, 62, 27, 29, -27, 
  43, 5, -7, 2, -12, 6, 49, -33, -28, -6, -1, 20, -3, -12, 19, -29, 
  -7, 79, 66, 6, 50, 61, -82, -2, -90, -26, 25, 12, 87, 4, 12, 14, 
};
const TfArray<2, int> tensor_dimension4 = { 2, { 8,16 } };
const TfArray<1, float> quant4_scale = { 1, { 0.0095544671639800072, } };
const TfLiteAffineQuantization quant4 = { (TfLiteFloatArray*)&quant4_scale, (TfLiteIntArray*)&g0::quant1_zero, 0 };
const MODEL_SECTION(EI_MODEL_SECTION) ALIGN(16) int32_t tensor_data5[16] = { -57, 837, 333, 645, 862, 585, 487, 393, 778, 768, 395, 429, 623, 348, 836, -180, };
const TfArray<1, int> tensor_dimension5 = { 1, { 16 } };
const TfArray<1, float> quant5_scale = { 1, { 0.00052701524691656232, } };
const TfLiteAffineQuantization quant5 = { (TfLiteFloatArray*)&quant5_scale, (TfLiteIntArray*)&g0::quant1_zero, 0 };
const MODEL_SECTION(EI_MODEL_SECTION) ALIGN(16) int8_t tensor_data6[16*7] = { 
  -23, -11, -34, 22, -25, 18, -6, 
  -6, 1, -8, -7, 1, -2, 94, 
  13, -16, -23, 1, -19, 3, 55, 
  -22, 4, 16, 9, 30, 12, -86, 
...
const TfArray<2, int> tensor_dimension6 = { 2, { 16,7 } };
const TfArray<1, float> quant6_scale = { 1, { 0.01606333814561367, } };
...
const TfArray<1, float> quant7_scale = { 1, { 0.02164972759783268, } };
const TfArray<1, int> quant7_zero = { 1, { -128 } };
const TfLiteAffineQuantization quant7 = { (TfLiteFloatArray*)&quant7_scale, (TfLiteIntArray*)&quant7_zero, 0 };
const TfArray<2, int> tensor_dimension8 = { 2, { 1,8 } };
const TfArray<1, float> quant8_scale = { 1, { 0.064510636031627655, } };
...
const TfArray<1, float> quant9_scale = { 1, { 0.35892733931541443, } };
...
{ kTfLiteMmapRo, kTfLiteInt8, (int32_t*)g0::tensor_data6, (TfLiteIntArray*)&g0::tensor_dimension6, 112, {kTfLiteAffineQuantization, const_cast<void*>(static_cast<const void*>(&g0::quant6))}, },
...
TfLiteStatus tflite_learn_767760_7_init( void*(*alloc_fnc)(size_t,size_t) ) {
...
TfLiteStatus tflite_learn_767760_7_input(int index, TfLiteTensor *tensor) {
  init_tflite_tensor(in_tensor_indices[index], tensor);
  return kTfLiteOk;
}

TfLiteStatus tflite_learn_767760_7_output(int index, TfLiteTensor *tensor) {
  init_tflite_tensor(out_tensor_indices[index], tensor);
  return kTfLiteOk;
}

TfLiteStatus tflite_learn_767760_7_invoke() {
...
TfLiteStatus tflite_learn_767760_7_reset( void (*free_fnc)(void* ptr) ) {
#ifdef EI_CLASSIFIER_ALLOCATION_HEAP
